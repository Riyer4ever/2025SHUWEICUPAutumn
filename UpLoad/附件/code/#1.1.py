...
plt.subplot(1, 2, 1)
plt.plot(t, y)
plt.xlabel('time / s'); plt.ylabel('y / m'); plt.title('Lateral displacement (no control)')

plt.subplot(1, 2, 2)
plt.plot(t, a)
plt.xlabel('time / s'); plt.ylabel('ÿ / m·s⁻²'); plt.title('Lateral acceleration (no control)')
plt.tight_layout()
plt.show()
